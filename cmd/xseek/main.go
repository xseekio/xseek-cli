...
func main() {
	...
	case "articles":
		...
		case "push":
			...
			commands.PushArticle(args[2], flags["title"], flags["file"], flags["status"], flags["meta-description"], flags["keyword-term"], flags["keywords"], flags["opportunity-id"], flags["visuals"])
		case "get":
			if len(args) < 4 {
		...
		case "update":
			...
			commands.UpdateArticle(args[2], args[3], flags["file"], flags["title"], flags["status"], flags["meta-description"], flags["opportunity-id"], flags["visuals"])
		case "publish":
			if len(args) < 5 {
